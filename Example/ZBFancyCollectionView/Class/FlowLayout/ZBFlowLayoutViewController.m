...
#import "ZBFlowLayoutViewController.h"

@interface ZBFlowLayoutViewController ()

@end

@implementation ZBFlowLayoutViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    self.collectionView = [UICollectionView flowLayout];
